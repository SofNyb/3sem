...
<section class="container">
    ...
    <div class="row justify-content-end">
        <div class="col-auto">
            <a class="fw-bold text-decoration-underline text-dark" href="index.php"><span class="p-1 bg-dark rounded-2 text-white fw-light me-2"><<</span>Klik her for at vende tilbage</a>
        </div>
    </div>
