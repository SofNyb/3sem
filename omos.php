...
<main id="snow-container">
    ...
    <section class="container-lg mt-5 pt-5 py-lg-5">
        <div class="animated fadeInTop row mt-0 mt-lg-5">
            ...
            <div class="col-lg-6">
                <img class="aboutHero" src="images/kragebjerggaardHoestfest.png" alt="Gruppe">
            </div>
    ...
    <section class="container-lg py-lg-5">
        <div class="animated fadeInTop row mt-0 mt-lg-5">
            ...
            <div class="col-lg-6 d-none d-lg-block">
                <img class="aboutHero" src="images/kragebjerggaardAutentisk.png" alt="Ko">
            </div>
    ...
    <section class="container-lg py-lg-5">
        <div class="animated fadeInTop mt-5">
            <img src="images/infografik.png" alt="Infografik">
        </div>
    </section>
    ...
    <section class="container-lg py-lg-5">
        <div class="animated fadeInTop row mt-0 mt-lg-5">
            ...
            <div class="col-lg-9">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9028.374169925237!2d11.651069883368903!3d55.54815676894038!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x46528422abd36d6d%3A0x6559ba81305fb08b!2sKragebjergg%C3%A5rd!5e0!3m2!1sen!2sdk!4v1670943197552!5m2!1sen!2sdk"
                        width="100%"
                        height="400"
                        style="border:0;"
                        allowfullscreen=""
            ...
            <div class="d-none d-lg-block bg-dark col-lg-3 text-light p-4 align-items-start">
                ...
                <hr>
                <p>Tlf.: 57 80 32 52</p>
                <p class="mt-3">kragebjerg@kb.com</p>
            </div>
